defmodule AceGrader.Accounts.User do
  use Ecto.Schema
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:email, :password, :username, :display_name, :account_type])
    |> validate_email(opts)
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, AceGrader.Repo)
  ...
  defp maybe_validate_unique_username(changeset, opts) do
    if Keyword.get(opts, :validate_username, true) do
      changeset
      |> unsafe_validate_unique(:username, AceGrader.Repo)
  ...
  @doc """
  A user changeset for changing the account information.
  """
  ...
  """
  def valid_password?(%AceGrader.Accounts.User{hashed_password: hashed_password}, password)
